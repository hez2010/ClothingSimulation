...
{
    class CapsuleCollisionObject : CollisionObject, IHasCollider
    {
        ...
        public override bool Hit(int index, Vector3 position, Vector3 velocity, float time, out CollisionResult? result)
        {
            ...
            {
                result = new CollisionResult(index, this, position + (velocity * reachTime), _collider.transform.TransformDirection(normal), reachTime);
                return true;
            }
